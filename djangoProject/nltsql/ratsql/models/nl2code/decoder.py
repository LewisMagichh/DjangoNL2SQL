...
from djangoProject.nltsql.ratsql.models import abstract_preproc
from djangoProject.nltsql.ratsql.models import attention
from djangoProject.nltsql.ratsql.models import variational_lstm
from djangoProject.nltsql.ratsql.models.nl2code.infer_tree_traversal import InferenceTreeTraversal
from djangoProject.nltsql.ratsql.models.nl2code.train_tree_traversal import TrainTreeTraversal
from djangoProject.nltsql.ratsql.models.nl2code.tree_traversal import TreeTraversal
from djangoProject.nltsql.ratsql.utils import registry
from djangoProject.nltsql.ratsql.utils import serialization
from djangoProject.nltsql.ratsql.utils import vocab
...
class NL2CodeDecoder(torch.nn.Module):
    ...
    def __init__(
        ...
        if use_align_mat:
            from djangoProject.nltsql.ratsql.models.spider import spider_dec_func
