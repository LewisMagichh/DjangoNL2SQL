...
from djangoProject.nltsql.ratsql.datasets import spider
from djangoProject.nltsql.ratsql.utils import registry
from djangoProject.nltsql.third_party.wikisql.lib import dbengine
from djangoProject.nltsql.third_party.wikisql.lib import query
